...
public class RegExUtils01 {
     ...
     * <ul>
     *  <li>{@code pattern.matcher(text).replaceAll("")}</li>
     * </ul>
     *
     ...
     * This method is a {@code null} safe equivalent to:
     * <ul>
     *  <li>{@code text.replaceAll(regex, "")}</li>
     *  <li>{@code Pattern.compile(regex).matcher(text).replaceAll("")}</li>
     * </ul>
     *
     * <p>A {@code null} reference passed to this method is a no-op.</p>
     *
     ...
     * This method is a {@code null} safe equivalent to:
     * <ul>
     *  <li>{@code pattern.matcher(text).replaceFirst("")}</li>
     * </ul>
     *
     * <p>A {@code null} reference passed to this method is a no-op.</p>
     *
     ...
     * This method is a {@code null} safe equivalent to:
     * <ul>
     *  <li>{@code text.replaceFirst(regex, "")}</li>
     *  <li>{@code Pattern.compile(regex).matcher(text).replaceFirst("")}</li>
     * </ul>
     *
     * <p>A {@code null} reference passed to this method is a no-op.</p>
     *
     ...
     * <ul>
     * <li>{@code text.replaceAll(&quot;(?s)&quot; + regex, "")}</li>
     * <li>{@code Pattern.compile(regex, Pattern.DOTALL).matcher(text).replaceAll("")}</li>
     * </ul>
     *
     * <p>A {@code null} reference passed to this method is a no-op.</p>
     *
    ...
    public static String replaceAll(final String text, final Pattern regex, final String replacement) {
        if (anyNull(text, regex, replacement)) {
            return text;
        }
    ...
    private static boolean allNotNull(final Object... values) {
        if (values == null) {
            return false;
        }
    ...
    private static boolean anyNull(final Object... values) {
